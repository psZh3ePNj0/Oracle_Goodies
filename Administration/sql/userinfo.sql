rem
rem Information about user - Tablespaces, Roles, Privileges, etc.
rem
rem Acknowledgements to resource responsible fr script: Doug Hahn
rem
rem Provide the user name along with the scriptname
rem

set serveroutput on feedback off verify off pages 0 echo off
spool userinfo.lst
declare
     wuser varchar2(255) := '&1';
     /*  Users */
